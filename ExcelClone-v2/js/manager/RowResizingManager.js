...
export class RowResizingManager {
    constructor(grid, commandManager) {
    ...
    onPointerUp(x, y, e) {
        var _a;
        const resizeCommand = new ResizeRowCommand(this.grid, this.grid.RESIZING_ROW, this.grid.RESIZING_ROW_OLD_HEIGHT, (_a = this.grid.ROW_HEIGHTS.get(this.grid.RESIZING_ROW)) !== null && _a !== void 0 ? _a : this.grid.DEFAULT_ROW_HEIGHT);
